...
set_partition_info -name "/my_custom_cape" -timestamp "1706749251"
set_partition_info -name "/my_custom_cape/BVF_RISCV_SUBSYSTEM_inst_0/IHC_SUBSYSTEM_0" -timestamp "1706749251"
set_compile_info \
...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"/home/aven/repos/riscv-fpga/my_custom_cape/synthesis/my_custom_cape.vm"}
set_compile_info \
    -category {"Options"} \
